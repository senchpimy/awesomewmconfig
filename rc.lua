...
awful.screen.connect_for_each_screen(function(s)
  ...
  awful.tag(
  { "₍ᐢ.  ̫.ᐢ₎", "૮ – ﻌ–ა", " 𐐘 ඞ  ", "ʕ´•ᴥ•`ʔ", "(`皿´＃)", " ˚ʚ♡ɞ˚ ",
    " ૮꒰ ˶• ༝ •˶꒱ა ♡ ", " ૮₍ ˃ ⤙ ˂ ₎ა", "༺♡༻" }, s, awful.layout.layouts[1])
  ...
  if battery_exists then
    ...
    s.mywibox:setup {
      ...
      {               -- Right widgets
        ...
        wibox.container.background(wibox.container.margin(separator("alpha", beautiful.bg_separator), 0, 0),
          beautiful.bg_normal),
        wibox.container.background(wibox.container.margin(volume_widget(), 4, 8), beautiful.bg_separator),
        wibox.container.background(wibox.container.margin(separator("alpha", beautiful.bg_normal), 0, 0),
          beautiful.bg_separator),
        todo_widget(),
        wibox.container.background(wibox.container.margin(separator("alpha", beautiful.bg_separator), 0, 0),
          beautiful.bg_normal),
        ...
        wibox.container.background(wibox.container.margin(separator("alpha", beautiful.bg_normal), 4, 0),
          beautiful.bg_separator),
...
local pomodoro = awmodoro.new({
  ...
  fg_color        = { type = "linear", from = { 0, 0 }, to = { pomowibox.width, 0 },
...
-- Dynamic tagging
  ...
  awful.key({ modkey }, "r", function()
      awful.util.spawn(
      'rofi -no-lazy-grab -show drun -modi drun,run,window -theme /home/plof/.config/rofi/launchers/style_1.rasi')
    end,
    { description = "run prompt", group = "launcher" }),
  awful.key({ modkey, "Control" }, "p",
    function() awful.util.spawn('sh /home/plof/.config/rofi/applets/applets/powermenu.sh') end,
...
-- Brightness
  ...
  awful.key({ modkey }, "Print",
    function() awful.util.spawn("scrot 'Screenshot-%Y-%m-%d-%s.jpg' -e 'mv $f " .. usr_home .. "/Pictures/$f'") end,
