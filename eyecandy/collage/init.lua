...
local helpers = require("eyecandy.helpers")

-- eyecandy collage submodule
-- eyecandy.collage
local collage = { _NAME = "eyecandy.collage" }
...
function collage.placeCollageImage(reqimgwidth, reqimgheight, posx, posy, align, imgsrcs, imgidx, ontop)
  ...
  local shadowsrc = homeDir .. "/.config/awesome/eyecandy/collage/shadow.png"
  local imgsrc = imgsrcs[imgidx]
  --local imgsrc = imgsrcs
